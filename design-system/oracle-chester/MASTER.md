...
**Project:** Oracle Chester
**Generated:** 2026-08-12 21:36:41
**Category:** Analytics Dashboard
**Design Dials:** Variance 5/10 (Balanced / Modern) | Motion 3/10 (Subtle) | Density 7/10 (Standard)

> **Application remap:** Live console uses `pages/query-console.md` and the CRM Field Desk tokens. Do not implement the generated BI-blue / amber / Fira Code headings on the hosted page.
